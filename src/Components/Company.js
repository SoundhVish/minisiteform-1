...
uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
 ...
 />
   ...
   />
      ...
      <FormControl>
      <FormLabel className="labels" htmlFor="my-input">Company Logo<br/>
      <i style={{fontSize:'10px'}}>Max. size:200px x 100px</i></FormLabel>
      <label className="custom-file-upload" id="file">
      
       
     
      </label>
      <Img_upload heading="Upload Logo" id="logo"></Img_upload>
      </FormControl>
